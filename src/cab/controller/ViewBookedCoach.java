...
public class ViewBookedCoach extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewBookedCoach frame = new ViewBookedCoach(" ");
	...
	public ViewBookedCoach(String username)  {
		setBounds(450, 220, 1050, 600);
		contentPane = new JPanel();
		setContentPane(contentPane);
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("cab/model/icons/Xe-du-lich-29-cho-hyunhdai-county.jpg"));
                Image i3 = i1.getImage().getScaledInstance(400, 350,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel la1 = new JLabel(i2);
                la1.setBounds(650,135,350,250);
                add(la1);
		
		JLabel lblName = new JLabel("CHUYẾN XE ĐÃ ĐẶT");
		...
		JLabel lblReserveRoomNumber = new JLabel("SDT tài xế:");
		lblReserveRoomNumber.setBounds(35, 310, 250, 14);
		...
		JLabel lblCheckInStatus = new JLabel("Ngày về:");
		...
		JLabel lblDeposite = new JLabel("Biển số xe:");
		...
		contentPane.add(l9);
                ...
                JLabel la2 = new JLabel("Thời gian:");
		...
		contentPane.add(l11);
                ...
                try{
                    ...
                    ResultSet rs = c.s.executeQuery("select * from dbo.intercityBOOK where username = '"+username+"'");
                    while(rs.next()){
						...
						l6.setText(rs.getString(9));
                    }
                    rs = c.s.executeQuery("select * from dbo.customer where username = '"+username+"'");
                    while(rs.next()){
...
//                        l8.setText(rs.getString("address"));
                    ...
                    Random r = new Random();
                    l10.setText(Math.abs((r.nextInt() % 10)) + " tiếng");
