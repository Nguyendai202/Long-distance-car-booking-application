...
public class CheckBill extends JFrame {
    ...
    CheckBill(String username) {
        ...
        try {
            ...
            ResultSet rs = c.s.executeQuery("select * from intercityBOOK where username = '" + username + "'");
            while (rs.next()) {
        ...
        String[] package1 = new String[]{"viewbill.png", "Thanh toán vé xe", price1};
        String[] package2 = new String[]{"package3.jpg", "Thanh toán vận chuyển", price2};

        JTabbedPane tabbedPane = new JTabbedPane();
        JPanel p1 = createPackage(package1);
        tabbedPane.addTab("DỊCH VỤ ĐẶT VÉ XE", null, p1);
        JPanel p2 = createPackage(package2);
        tabbedPane.addTab("DỊCH VỤ VẬN CHUYỂN", null, p2);
    ...
    public JPanel createPackage(String[] pack) {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("cab/model/icons/" + pack[0]));
        Image i3 = i1.getImage().getScaledInstance(550, 300, Image.SCALE_DEFAULT);
        ImageIcon i2 = new ImageIcon(i3);
        JLabel l1 = new JLabel(i2);
        l1.setBounds(300, 60, 550, 300);
        p1.add(l1);
        ...
        JLabel lblId = new JLabel("TỔNG TIỀN");
        ...
        JLabel la1 = new JLabel("Kiểm tra kĩ tổng số tiền cần thanh toán, nếu có vấn đề gì vui lòng liên hệ chúng tôi tại mục PHẢN HỒI!");
        la1.setFont(new Font("Yu Mincho", Font.PLAIN, 17));
