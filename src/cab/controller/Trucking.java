...
public class Trucking extends JFrame{ 
	...
	setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        ...
        ReservationDetails = new JLabel("Dịch vụ vận chuyển");
	...
	Destination.setBounds(500, 100, 150, 27);
	add(Destination);
	...
	c1 = new Choice();
        c1.setBounds(150, 100, 300, 27);
        add(c1);
      	
	c2 = new Choice();
        c2.setBounds(650, 100, 300, 27);
        add(c2);
        
        try{
            ConnectDatabase c = new ConnectDatabase();
            ResultSet rs = c.s.executeQuery("select * from intercityBOOK");
            while(rs.next()){
        ...
        JLabel l11 = new JLabel("Khối lượng: ");
	...
	add(show);
        ...
        JLabel l1 = new JLabel("Người lái xe: ");
	...
	add(l6);
        ...
        JLabel l7 = new JLabel("Khoảng cách: ");
	...
	add(l4);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("cab/model/icons/transport.jpeg"));
	...
	show.addActionListener(new ActionListener(){
		...
		try{
                    ...
                    ConnectDatabase c = new ConnectDatabase();
                    // lấy dữ liệu vận chuyển từ database ra
		...
		try{
                    ...
                    // ghi vào database những gì người dùng chọn
