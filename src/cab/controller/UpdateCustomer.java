...
public class UpdateCustomer extends JFrame {
	...
	public UpdateCustomer(String username) throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("cab/model/icons/update.png"));
		...
		JLabel lblName = new JLabel("CẬP NHẬT THÔNG TIN CÁ NHÂN");
		lblName.setFont(new Font("Yu Mincho", Font.PLAIN, 20));
		lblName.setBounds(118, 11, 400, 30);
		...
		t2.setColumns(10);
                ...
                JLabel l2 = new JLabel("Số giấy tờ:");
