...
public class ForgotPassword extends JFrame implements ActionListener{
    ...
    public ForgotPassword() {
        ...
        setBounds(500, 200, 850, 400);// show ra cửa sổ
	...
	t1.setForeground(new Color(255, 204, 237));
	t1.setBounds(277, 88, 139, 20);
	contentPane.add(t1);
	t1.setColumns(10);// 10 kí tự thôi

	t2 = new JTextField();
	t2.setEditable(false);// ko điền được , chỉ kq lên thôi
	...
	contentPane.add(t5);
        ...
        ImageIcon c1 = new ImageIcon(ClassLoader.getSystemResource("cab/model/icons/forgotpassword_new.png"));
        Image i1 = c1.getImage().getScaledInstance(200, 200,Image.SCALE_DEFAULT);
        ImageIcon i2 = new ImageIcon(i1);// ko liên quan đến i1 , chỉ là mượn để tạo đối tượng thôi
...
//	contentPane.add(panel);
    ...
    public void actionPerformed(ActionEvent ae){
		...
		while (rs.next()) {
                    t2.setText(rs.getString("name"));// lấy giá trị trong cột name ở database
