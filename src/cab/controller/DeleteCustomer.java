...
public class DeleteCustomer extends JFrame {
	...
	public DeleteCustomer() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("cab/model/icons/delete.png"));
		...
		JLabel lblName = new JLabel("XOÁ THÔNG TIN");
		...
		contentPane.add(l2);
                ...
                JLabel lb2 = new JLabel("Số giấy tờ:");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                            ...
                            try{
	    			String s1 = c1.getSelectedItem(); // lấy ra text đc chọn trong choice
